...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Espers
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Espers
    // Mac: ~/Library/Application Support/Espers
    // Unix: ~/.Espers
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Espers";
#else
    fs::path pathRet;
